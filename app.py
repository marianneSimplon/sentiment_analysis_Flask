...
def predict():
    ...
    if request.method == 'POST':
        if request.form['customer_feedback']:
            ...
            return render_template('recommandation.html', text=customer_feedback, recommandation=recommandation, score=f"Note estimée : {score}/100", texttrans=clean_comment)
